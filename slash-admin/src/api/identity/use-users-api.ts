...
export function useUserApi() {
	...
	function getOrganizationUnitsApi(id: string): Promise<ListResultDto<OrganizationUnitDto>> {
		return request<ListResultDto<OrganizationUnitDto>>(`/api/identity/users/${id}/organization-units`, {
			method: "GET",
		});
	}
	...
	function getAssignableRolesApi(): Promise<ListResultDto<IdentityRoleDto>> {
		return request<ListResultDto<IdentityRoleDto>>(`/api/identity/users/assignable-roles`, {
			method: "GET",
		});
	}
	...
	function getClaimsApi(id: string): Promise<ListResultDto<IdentityClaimDto>> {
		return request<ListResultDto<IdentityClaimDto>>(`/api/identity/users/${id}/claims`, {
			method: "GET",
		});
	}
	 ...
	 * @param input 用户声明dto
	 */
	function deleteClaimApi(id: string, input: IdentityClaimDeleteDto): Promise<void> {
	 ...
	 * @param input 用户声明dto
	 */
	function createClaimApi(id: string, input: IdentityClaimCreateDto): Promise<void> {
		return request(`/api/identity/users/${id}/claims`, {
			data: input,
			method: "POST",
		});
	 ...
	 * @param input 用户声明dto
	 */
	function updateClaimApi(id: string, input: IdentityClaimUpdateDto): Promise<void> {
		return request(`/api/identity/users/${id}/claims`, {
			data: input,
			method: "PUT",
		});
