...
export function useSecurityLogsApi() {
	 ...
	 */
	function getPagedListApi(input?: GetSecurityLogPagedRequest): Promise<PagedResultDto<SecurityLogDto>> {
		return request<PagedResultDto<SecurityLogDto>>(`/api/auditing/security-log`, {
			method: "GET",
			params: input,
		});
	}
