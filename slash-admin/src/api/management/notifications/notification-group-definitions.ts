...
export function getApi(name: string): Promise<NotificationGroupDefinitionDto> {
  return requestClient.get<NotificationGroupDefinitionDto>(
    `/api/notifications/definitions/groups/${name}`,
  );
}
...
export function getListApi(
  ...
  return requestClient.get<ListResultDto<NotificationGroupDefinitionDto>>(
...
export function createApi(
  ...
  return requestClient.post<NotificationGroupDefinitionDto>(
    "/api/notifications/definitions/groups",
    input,
  );
}
...
export function updateApi(
  ...
  return requestClient.put<NotificationGroupDefinitionDto>(
    `/api/notifications/definitions/groups/${name}`,
    input,
  );
}