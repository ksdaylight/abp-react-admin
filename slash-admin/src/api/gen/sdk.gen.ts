...
export const emailSettingsUpdate = <ThrowOnError extends boolean = false>(
	options?: OptionsLegacyParser<EmailSettingsUpdateData, ThrowOnError>,
) => {
	return (options?.client ?? client).post<
		EmailSettingsUpdateResponse,
		EmailSettingsUpdateError,
...
export const emailSettingsSendTestEmail = <
	ThrowOnError extends boolean = false,
>(
	options?: OptionsLegacyParser<EmailSettingsSendTestEmailData, ThrowOnError>,
) => {
	return (options?.client ?? client).post<
		EmailSettingsSendTestEmailResponse,
		EmailSettingsSendTestEmailError,
...
export const timeZoneSettingsUpdate = <ThrowOnError extends boolean = false>(
	options?: OptionsLegacyParser<TimeZoneSettingsUpdateData, ThrowOnError>,
) => {
	return (options?.client ?? client).post<
		TimeZoneSettingsUpdateResponse,
		TimeZoneSettingsUpdateError,
