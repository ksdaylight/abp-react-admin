...
export function findNode(children: PermissionTree[], key: string): PermissionTree | undefined {
...
export function getParentList(children: PermissionTree[], name: string): PermissionTree[] | undefined {
	for (const child of children) {
		if (child.name === name) {
			return [child];
		}
...
export function getChildren(permissions: PermissionTree[]): PermissionTree[] {
