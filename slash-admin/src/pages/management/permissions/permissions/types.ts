...
export function useTypesMap($t: TFunction<any>) {
	const multiTenancySidesMap: { [key: number]: string } = {
		[MultiTenancySides.Both]: $t("AbpPermissionManagement.MultiTenancySides:Both"),
		[MultiTenancySides.Host]: $t("AbpPermissionManagement.MultiTenancySides:Host"),
		[MultiTenancySides.Tenant]: $t("AbpPermissionManagement.MultiTenancySides:Tenant"),
	};
