...
import { Drawer, Form, Input, Checkbox, DatePicker, Tabs, Tag } from "antd";
...
import { getHttpStatusColor, httpStatusCodeMap } from "@/utils/abp/http-status-code"; // Assuming util exists
import CodeEditor from "@/components/abp/code-editor"; // Assuming component
import Tinymce from "@/components/abp/tinymce"; // Assuming component
          ...
          <Tabs activeKey={activeTab} onChange={setActiveTab}>
            ...
            <Tabs.TabPane key="basic" tab={$t("WebhooksManagement.BasicInfo")}>
              ...
              <Form.Item label={$t("WebhooksManagement.DisplayName:Response")}>
                {/* Fallback to textarea if TinyMCE is heavy or not needed for read-only json/text */}
