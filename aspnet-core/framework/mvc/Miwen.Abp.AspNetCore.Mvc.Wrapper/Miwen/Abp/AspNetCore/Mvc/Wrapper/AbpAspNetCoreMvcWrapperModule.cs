using Miwen.Abp.AspNetCore.Mvc.Wrapper.Filters;
using Miwen.Abp.AspNetCore.Mvc.Wrapper.Localization;
...
namespace Miwen.Abp.AspNetCore.Mvc.Wrapper;
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Miwen/Abp/AspNetCore/Mvc/Wrapper/Localization/Resources");
        });
