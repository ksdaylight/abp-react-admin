using Miwen.Abp.Features.LimitValidation.Localization;
...
namespace Miwen.Abp.Features.LimitValidation;
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Miwen/Abp/Features/LimitValidation/Localization/Resources");
        });
    }
}
