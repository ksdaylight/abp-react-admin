...
public static class LocalizationDbContextModelBuilderExtensions
{
       ...
       Action<LocalizationModelBuilderConfigurationOptions> optionsAction = null)
    {
        ...
        builder.Entity<Language>(x =>
        {
            ...
            x.Property(p => p.TwoLetterISOLanguageName)
                .IsRequired(false)
                .HasMaxLength(LanguageConsts.MaxTwoLetterISOLanguageNameLength)
                .HasColumnName(nameof(Language.TwoLetterISOLanguageName));
