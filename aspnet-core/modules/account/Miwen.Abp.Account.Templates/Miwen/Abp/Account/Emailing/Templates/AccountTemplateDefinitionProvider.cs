...
namespace Miwen.Abp.Account.Emailing.Templates;
...
public class AccountTemplateDefinitionProvider : TemplateDefinitionProvider
{
    public override void Define(ITemplateDefinitionContext context)
    {
        context.Add(
            ...
            ).WithVirtualFilePath("/Miwen/Abp/Account/Emailing/Templates/MailSecurityVerify.tpl", true),
            new TemplateDefinition(
                AccountEmailTemplates.MailConfirmLink,
                displayName: L($"TextTemplate:{AccountEmailTemplates.MailConfirmLink}"),
                layout: StandardEmailTemplates.Layout,
                localizationResource: typeof(AccountResource)
            ).WithVirtualFilePath("/Miwen/Abp/Account/Emailing/Templates/MailConfirm.tpl", true)
        );
    }
