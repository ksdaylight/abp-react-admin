...
using Miwen.Abp.BackgroundTasks.Internal;
...
public class SingleDbMigrationEventHandler: EfCoreDatabaseMigrationEventHandlerBase<SingleMigrationsDbContext>,
    IDistributedEventHandler<EntityDeletedEto<TenantEto>>
{
    ...
    public SingleDbMigrationEventHandler(
        ...
        : base("Default", currentTenant, unitOfWorkManager, tenantStore, abpDistributedLock, distributedEventBus, loggerFactory)
    {
