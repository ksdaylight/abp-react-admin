...
{    
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<MicroServiceApplicationsSingleModule>("Miwen.MicroService.Applications.Single");
        });
    }
    ...
    private void ConfigureSecurity(IServiceCollection services, IConfiguration configuration, bool isDevelopment = false)
    {
        ...
        if (!isDevelopment)
        {
            ...
            services
                .AddDataProtection()
                .SetApplicationName("Miwen.Abp.Application")
                .PersistKeysToStackExchangeRedis(redis, "Miwen.Abp.Application:DataProtection:Protection-Keys");
        }
    ...
    //        // 回复文本消息
    //        options.MapMessage<
    //            Miwen.Abp.WeChat.Official.Messages.Models.TextMessage,
    //            Miwen.MicroService.Applications.Single.WeChat.Official.Messages.TextMessageReplyContributor>();
    //        // 处理关注事件
    //        options.MapEvent<
    //            Miwen.Abp.WeChat.Official.Messages.Models.UserSubscribeEvent,
    //            Miwen.MicroService.Applications.Single.WeChat.Official.Messages.UserSubscribeEventContributor>();

    //        options.MapMessage<
    //            Miwen.Abp.WeChat.Work.Common.Messages.Models.TextMessage,
    //            Miwen.MicroService.Applications.Single.WeChat.Work.Messages.TextMessageReplyContributor>();
    //    });
    //}
}
