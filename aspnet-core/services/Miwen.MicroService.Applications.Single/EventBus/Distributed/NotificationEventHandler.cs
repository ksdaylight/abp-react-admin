...
using Miwen.MicroService.Applications.Single.BackgroundJobs;
using Miwen.MicroService.Applications.Single.MultiTenancy;
...
namespace Miwen.MicroService.Applications.Single.EventBus.Distributed
{
    /// <summary>
    /// 订阅通知发布事件,统一发布消息
    /// </summary>
